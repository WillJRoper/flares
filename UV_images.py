...
def img_main(path, snap, reg, res, npart_lim=10**3, dim=0.1, load=True, conv=1, scale=0.01):
    ...
    for id in gal_ages.keys():
        ...
        for key in galimgs.keys():
            ...
            # Draw images
            im1 = ax1.imshow(galimgs[key]['mass'], extent=extents[key], cmap='Greys_r')
            im2 = ax2.imshow(galimgs[key]['metals'], extent=extents[key], cmap='Greys_r')
            im3 = ax3.imshow(galimgs[key]['FAKE.TH.V'], extent=extents[key], cmap='Greys_r')
            im4 = ax4.imshow(galimgs[key]['FAKE.TH.NUV'], extent=extents[key], cmap='Greys_r')
            im5 = ax5.imshow(galimgs[key]['FAKE.TH.FUV'], extent=extents[key], cmap='Greys_r')
            ...
            # Label colorbars
            cbar1.ax.set_xlabel(r'$M_{\star}/M_{\odot}$', fontsize=2, color='w', labelpad=0.75)
            ...
            cbar3.ax.set_xlabel(r'$L_{\mathrm{V}}/[\mathrm{erg}/\mathrm{s}]$', fontsize=2, color='w', labelpad=0.75)
            ...
            cbar4.ax.set_xlabel(r'$L_{\mathrm{NUV}}/[\mathrm{erg}/\mathrm{s}]$', fontsize=2, color='w', labelpad=0.75)
            ...
            cbar5.ax.set_xlabel(r'$L_{\mathrm{FUV}}/[\mathrm{erg}/\mathrm{s}]$', fontsize=2, color='w', labelpad=0.75)
