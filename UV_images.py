...
def img_main(path, snap, reg, res, npart_lim=10**3, dim=0.1, load=True, conv=1, scale=0.01):
    ...
    for id in gal_ages.keys():
        ...
        for key in galimgs.keys():
            ...
            im1 = ax1.imshow(plt_im1, extent=extents[key], cmap='viridis')
            im2 = ax2.imshow(plt_im2, extent=extents[key], cmap='viridis')
            im3 = ax3.imshow(plt_im3, extent=extents[key], cmap='viridis')
            im4 = ax4.imshow(plt_im4, extent=extents[key], cmap='viridis')
            im5 = ax5.imshow(plt_im5, extent=extents[key], cmap='viridis')
            im6 = ax6.imshow(plt_im6, extent=extents[key], cmap='viridis')
            ...
            ax1.plot([right_side - scale, right_side], [vert, vert], color='k', linewidth=0.5)
            ax2.plot([right_side - scale, right_side], [vert, vert], color='k', linewidth=0.5)
            ax3.plot([right_side - scale, right_side], [vert, vert], color='k', linewidth=0.5)
            ax4.plot([right_side - scale, right_side], [vert, vert], color='k', linewidth=0.5)
            ax5.plot([right_side - scale, right_side], [vert, vert], color='k', linewidth=0.5)
            ax6.plot([right_side - scale, right_side], [vert, vert], color='k', linewidth=0.5)
            ...
            # Label colorbars
            cbar1.ax.set_xlabel(r'$\log_{10}(M_{\star}/M_{\odot})$', fontsize=2, color='k', labelpad=1.0)
            cbar1.ax.xaxis.set_label_position('top')
            cbar1.outline.set_edgecolor('k')
            cbar1.outline.set_linewidth(0.05)
            cbar1.ax.tick_params(axis='x', length=1, width=0.2, pad=0.01, labelsize=2, color='k', labelcolor='k')
            cbar2.ax.set_xlabel(r'$\log_{10}(Z_{\mathrm{los}}/[\mathrm{g}/\mathrm{ccm}^{2}])$', fontsize=2, color='k',
                                labelpad=1.0)
            cbar2.ax.xaxis.set_label_position('top')
            cbar2.outline.set_edgecolor('k')
            cbar2.outline.set_linewidth(0.05)
            cbar2.ax.tick_params(axis='x', length=1, width=0.2, pad=0.01, labelsize=2, color='k', labelcolor='k')
            cbar3.ax.set_xlabel(r'$\log_{10}(L_{\mathrm{V}}/[\mathrm{erg}/\mathrm{s}/\mathrm{Hz}])$', fontsize=2, color='k',
                                labelpad=1.0)
            cbar3.ax.xaxis.set_label_position('top')
            cbar3.outline.set_edgecolor('k')
            cbar3.outline.set_linewidth(0.05)
            cbar3.ax.tick_params(axis='x', length=1, width=0.2, pad=0.01, labelsize=2, color='k', labelcolor='k')
            cbar4.ax.set_xlabel(r'$\log_{10}(L_{\mathrm{NUV}}/[\mathrm{erg}/\mathrm{s}/\mathrm{Hz}])$', fontsize=2, color='k',
                                labelpad=1.0)
            cbar4.ax.xaxis.set_label_position('top')
            cbar4.outline.set_edgecolor('k')
            cbar4.outline.set_linewidth(0.05)
            cbar4.ax.tick_params(axis='x', length=1, width=0.2, pad=0.01, labelsize=2, color='k', labelcolor='k')
            cbar5.ax.set_xlabel(r'$\log_{10}(L_{\mathrm{FUV}}/[\mathrm{erg}/\mathrm{s}/\mathrm{Hz}])$', fontsize=2, color='k',
                                labelpad=1.0)
            cbar5.ax.xaxis.set_label_position('top')
            cbar5.outline.set_edgecolor('k')
            cbar5.outline.set_linewidth(0.05)
            cbar5.ax.tick_params(axis='x', length=1, width=0.2, pad=0.01, labelsize=2, color='k', labelcolor='k')
            cbar6.ax.set_xlabel(r'$\log_{10}(\mathrm{SFR}/[\mathrm{M}_{\star}/\mathrm{yr}])$', fontsize=2, color='k',
                                labelpad=1.0)
            cbar6.ax.xaxis.set_label_position('top')
            cbar6.outline.set_edgecolor('k')
            cbar6.outline.set_linewidth(0.05)
            cbar6.ax.tick_params(axis='x', length=1, width=0.2, pad=0.01, labelsize=2, color='k', labelcolor='k')
