...
def main_change(masslim=1e8, hmrcut=False, load=False):
    ...
    if load:
        ...
        with open('changeinsize_feedbackREF.pck', 'rb') as pfile1:
        ...
        for snap, prog_snap in zip(snaps, prog_snaps):
            ...
            try:
                ...
                delta_hmr_dict[snap], delta_ms_dict[snap], fbs_dict[snap] = results_tup

            except OSError:
                continue

        with open('changeinsize_feedbackREF.pck', 'wb') as pfile1:
    ...
    fig.savefig('plots/change_in_massvsfeedbackREF.png', bbox_inches='tight')
    ...
    fig.savefig('plots/change_in_halfmassradius_feedbackREF.png', bbox_inches='tight')
    ...
    fig.savefig('plots/change_in_halfmassradiusvsfeedbackREF.png', bbox_inches='tight')
