...
def main_evolve_graph(pcent):
    ...
    fig.savefig("plots/gas_stellar_formation_hmr_" + str(pcent) + ".png", bbox_inches="tight")
    ...
    fig.savefig("plots/gas_stellar_formation_stellarhmr_" + str(pcent) + ".png", bbox_inches="tight")
