...
# Extarct M_200s
M_200 = get_mass_data('/cosma7/data/dp004/dc-love2/data/G-EAGLE/geagle_0032/data/', '009_z006p000',
                      "FOF/Group_M_Crit200", group="SUBFIND_GROUP", noH=True, cut_bounds=True)
M_200_hrDMO = get_mass_data('/cosma7/data/dp004/dc-love2/data/G-EAGLE/geagle_0032_hires/data/', '009_z006p000',
                      "FOF/Group_M_Crit200", group="SUBFIND_GROUP", noH=True, cut_bounds=True)
M_200_hr = get_mass_data('/cosma7/data/dp004/dc-rope1/G-EAGLE32_hires/data/', '009_z006p000',
                      "FOF/Group_M_Crit200", group="SUBFIND_GROUP", noH=True, cut_bounds=True)
...
# Save figure
fig.savefig('mass_func_res_comp.png', bbox_inches='tight')
