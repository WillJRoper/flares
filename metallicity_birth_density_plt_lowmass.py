...
def get_data(masslim=1e8, load=False):
    ...
    if load:
        ...
        with open('metvsbd_lowmass.pck', 'rb') as pfile1:
        ...
        with open('metvsbd_lowmass.pck', 'wb') as pfile1:
...
fig.savefig('plots/birthdensity_metallicity_redshift_lowmass.png', bbox_inches='tight')
