...
def get_data(masslim=1e8, load=False):
    ...
    if load:
        ...
        with open('metvsbd_meanden.pck', 'rb') as pfile1:
        ...
        with open('metvsbd_meanden.pck', 'wb') as pfile1:
...
fig.savefig('plots/birthdensity_metallicity_redshift_meandensity.png', bbox_inches='tight')
