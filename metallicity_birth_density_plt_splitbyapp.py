        ...
        for reg in regions:
            ...
            for snap, prog_snap in zip(snaps, prog_snaps):
                ...
                try:
                    ...
                    gal_cop = E.read_array('SUBFIND', path, snap, 'Subhalo/CentreOfPotential	',
                                          noH=True, physicalUnits=True, numThreads=8) * 1e3
                    gal_bd = E.read_array('PARTDATA', path, snap, 'PartType4/BirthDensity', noH=True,
                                            physicalUnits=True, numThreads=8)
                    gal_coords = E.read_array('PARTDATA', path, snap, 'PartType4/Coordinates', noH=True,
                                              physicalUnits=True, numThreads=8)
