    ...
    for reg in regions:
        ...
        for snap, prog_snap in zip(snaps, prog_snaps):
            ...
            for halo, cop, m, hmr in zip(halo_ids, gal_cop, gal_ms, gal_hmr):
                ...
                prof_rs = rs[okinds]
                prof_parts_aborn = parts_aborn[okinds]
                ...
                #
                # fig.savefig("plots/metprof_%.1f_hmrrange_hmrrange.png" % np.log10(m),
                #             bbox_inches="tight")
                #
                # plt.close(fig)
                ...
                recent_rs = rs[okinds]
                recent_part_aborn = parts_aborn[okinds]
...
fig.savefig("plots/stellar_met_grad_evo_hmrrange_scatter.png", bbox_inches="tight")
...
okinds3 = np.logical_and(recent_zs_all > 3, recent_zs_all <= 5)
okinds4 = recent_zs_all > 5
