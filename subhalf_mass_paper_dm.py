...
for ax, snap, (i, j) in zip([ax1, ax2, ax3, ax4, ax5, ax6, ax7, ax8, ax9], snaps,
    ...
    if j == 0:
        ax.set_ylabel('$R_{1/2,\mathrm{dm}}/ [pkpc]$')
    ax10.set_xlabel(r'$M_{\star}/M_\odot$')
    ax10.set_ylabel('$R_{1/2,\mathrm{dm}}/\epsilon$')

    fig1.savefig('plots/DMHalfMassRadius_' + snap + '.png',
                bbox_inches='tight')
...
#             bbox_inches='tight')
fig.savefig('plots/DMHalfMassRadius_all_snaps.png',
            bbox_inches='tight')
