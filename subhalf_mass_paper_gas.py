...
for ax, snap, (i, j) in zip([ax1, ax2, ax3, ax4, ax5, ax6, ax7, ax8, ax9], snaps,
    ...
    if j == 0:
        ax.set_ylabel('$R_{1/2,\mathrm{gas}}/ [pkpc]$')
    ax10.set_xlabel(r'$M_{\star}/M_\odot$')
    ax10.set_ylabel('$R_{1/2,\mathrm{gas}}/\epsilon$')

    fig1.savefig('plots/GasHalfMassRadius_' + snap + '.png',
                bbox_inches='tight')
...
#             bbox_inches='tight')
fig.savefig('plots/GasHalfMassRadius_all_snaps.png',
            bbox_inches='tight')
...
fig.savefig("plots/GasHalfMassRadius_z_evolution.png", bbox_inches="tight")
...
fig.savefig("plots/GasHalfMassRadius_z_evolution_age.png", bbox_inches="tight")
