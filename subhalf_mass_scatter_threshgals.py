...
gsnaps = reversed(['000_z015p000', '001_z014p000', '002_z013p000', '003_z012p000', '004_z011p000', '005_z010p000',
...
for reg in regions:
    ...
    for snap in snaps:
        ...
        print(len(group_ids), len(half_mass_rads_dict[snap][reg]), len(axis_dict[snap][reg]))
        ms[snap][reg] = {}
        rs[snap][reg] = {}
