...
starmass_dict = {}
cbars = {}
labels = ['$M_{\mathrm{gas}}/M_\odot + 1$', '$M_{\mathrm{DM}}/M_\odot + 1$', '_', '_', '$M_{*}/M_\odot + 1$']
for drop, parts, ax, title in zip([0, 1, 4], [(1, 4), (0, 4), (0, 1)], [ax1, ax2, ax3],
    ...
    cbars[drop] = ax.hexbin(x_plt, y_plt, gridsize=100, mincnt=1, xscale='log', norm=LogNorm(1, 10**6),
    ...
    ax.set_xlim(0.5 * 10**-1, None)
    ax.set_ylim(0.5 * 10 ** -1, None)
